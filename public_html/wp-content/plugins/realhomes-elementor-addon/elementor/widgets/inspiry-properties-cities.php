            ...
            <div class="rhea_properties_cities_wrapper">
				...
				foreach ( $repeater_city as $city ) {
                    ...
                    <div class="rhea_property_city">
                        ...
                        <a class="rhea_property_city_inner" style="flex-direction: <?php echo esc_attr($settings['rhea_city_position'])?>"
                           href="<?php echo get_term_link( $city['rhea_property_location_select_section'], 'property-city' ) ?>">
