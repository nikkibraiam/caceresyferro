...
class RHEA_Testimonial_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Testimonials', 'realhomes-elementor-addon' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Slides To Show On', 'plugin-name' ),
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__( 'Fluid Width 1440px or Greater', 'plugin-domain' ),
		...
		$this->add_control(
			'slides_to_show',
			[
				'label'   => esc_html__( 'Desktop < 1440px', 'plugin-domain' ),
				'type'    => \Elementor\Controls_Manager::NUMBER,
				'min'     => 1,
				'max'     => 6,
				'step'    => 1,
		...
		$this->add_control(
			'slides_to_show_tab',
			[
				'label'   => esc_html__( 'Tab < 1024px', 'plugin-domain' ),
				'type'    => \Elementor\Controls_Manager::NUMBER,
				'min'     => 1,
				'max'     => 6,
				'step'    => 1,
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__( 'Mobile < 767px', 'plugin-domain' ),
				'type'    => \Elementor\Controls_Manager::NUMBER,
				'min'     => 1,
				'max'     => 6,
				'step'    => 1,
