					...
					foreach ( $additional_fields as $field ) {
						...
						if ( in_array( $field['field_type'], array( 'select', 'checkbox_list', 'radio' ) ) ) {
							...
							if ( defined( 'ICL_LANGUAGE_CODE' ) ) {
								$options = explode( ',', apply_filters( 'wpml_translate_single_string', implode( ',', $field['field_options'] ), 'Additional Fields', $field['field_name'], ICL_LANGUAGE_CODE ) );
	...
	public function register_additional_fields_for_translation( $null, $field, $new_fields ) {
		...
		foreach ( $new_fields as $field ) {
			if ( 'checkbox_list' === $field['field_type'] || 'select' === $field['field_type'] || 'radio' === $field['field_type'] ) {
				do_action( 'wpml_register_single_string', 'Additional Fields', $field['field_name'], $field['field_options'] );
			}
		}
	}
