            ...
            <div class="membership-info">
                <div class="dl-list">
                    ...
                    <dl>
                        ...
                        <dd><?php echo date_i18n( get_option( 'date_format' ), get_user_meta( $current_user_id, 'ims_membership_due_date', true ) ); ?></dd>
                    </dl>
                </div>
            </div>

            <a class="change-package btn btn-primary" href="<?php echo esc_url( realhomes_get_dashboard_page_url( 'membership&submodule=packages' ) ) ?>">
